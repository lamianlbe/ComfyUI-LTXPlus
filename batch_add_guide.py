...
Why a separate node when chaining LTXVAddGuide already works?
  - Compact: one node instead of N
  - Easier to wire when the keyframe count is variable / data-driven
  - Single strength widget (chained nodes each have their own)
"""
...
@comfy_node(name="LTXPlusBatchAddGuide")
