...
that plugs into LTXPlusGenerate's guider input.
...
Note: This guider handles STRUCTURAL CONTROL (pose/canny/depth).
Appearance keyframes (key_frames + key_frame_poses) are handled separately
by LTXPlusGenerate's frame injection section. Both can be used together.
"""
        ...
        return {
            ...
            "optional": {
                ...
                "stg_indexes":       ("STRING", {"default": "0",
                                                 "tooltip": "Attention index to perturb. 0 = self-attention (default STG), 1 = cross-attention."}),
...
NODE_CLASS_MAPPINGS = {"LTXPlusICLoRAGuider": LTXPlusICLoRAGuider}
NODE_DISPLAY_NAME_MAPPINGS = {"LTXPlusICLoRAGuider": "🅛🅣🅧 LTX Plus IC-LoRA Guider"}
